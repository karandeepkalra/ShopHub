        ...
        <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl p-8 border border-white/20 animate-slide-in-left">
          {!showResetForm ? (
            <form className="space-y-6" onSubmit={handleSubmit}>
              {error && (
                <div className="bg-red-50 border border-red-200 text-red-600 px-4 py-3 rounded-lg text-sm animate-fade-in-up flex items-center gap-2">
              ...
              {info && (
                <div className="bg-blue-50 border border-blue-200 text-blue-600 px-4 py-3 rounded-lg text-sm animate-fade-in-up flex items-center gap-2">
                  <AlertCircle className="w-4 h-4" />
                  {info}
                </div>
              )}
              ...
              {success && (
                <div className="bg-green-50 border border-green-200 text-green-600 px-4 py-3 rounded-lg text-sm animate-fade-in-up flex items-center gap-2">
                    ...
                    {success.includes('demo purposes') && (
                      <p className="text-xs mt-1">
                        <button 
                          ...
                          className="underline hover:no-underline text-green-700"
                        >
              ...
              <div className="group">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 hover:border-gray-400"
                  />
                </div>
              </div>
