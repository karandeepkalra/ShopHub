        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-4">
              Your one-stop destination for trendy clothing and fashion accessories.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/category/men" className="text-gray-400 hover:text-white text-sm">Men's Clothing</Link></li>
              <li><Link to="/category/women" className="text-gray-400 hover:text-white text-sm">Women's Clothing</Link></li>
              <li><Link to="/category/kids" className="text-gray-400 hover:text-white text-sm">Kids & Baby</Link></li>
              <li><Link to="/category/accessories" className="text-gray-400 hover:text-white text-sm">Accessories</Link></li>
              <li><Link to="/category/shoes" className="text-gray-400 hover:text-white text-sm">Footwear</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/returns" className="text-gray-400 hover:text-white text-sm">Returns & Exchanges</Link></li>
